...
static char modeChar[MODE_COUNT*2][3][3][5] = 
{
	...
	{	//numbers
		{ {   DANZEFF_TAB    ,   DANZEFF_CONTROL, DANZEFF_SHIFT     , '1', '\0' }, 
      {   0              ,   DANZEFF_SUPPR  , DANZEFF_CAPSLOCK  , '2', '\0' }, 
      {   DANZEFF_SUPPR  ,   DANZEFF_ALT    , DANZEFF_SHIFT     , '3', '\0' }},

		{ {   0              ,   DANZEFF_SHIFT, 0               , '4', '\0' }, 
      {   DANZEFF_DEL    ,   0          ,                ' ', '5', '\0' }, 
      {   DANZEFF_ENTER  ,   0          ,  0                , '6', '\0' }},

		{ {   0              ,   DANZEFF_ENTER,   0             , '7', '\0' }, 
      {   0              ,   0          ,  0                , '8', '\0' }, 
      {   0              ,   0          ,                '0', '9', '\0' }},
	},
...
{
  char skin_path[128];
  strcpy(skin_path, TI99.ti99_home_dir);
...
danzeff_load()
{
  ...
  if (psp_kbd_skin_first) {
	...
	{
    strcpy(tmp_filename, TI99.ti99_home_dir );
