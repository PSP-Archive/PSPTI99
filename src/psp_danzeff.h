...
#define  DANZEFF_TAB             3
#define  DANZEFF_DEL             4
#define  DANZEFF_ENTER           5
#define  DANZEFF_SHIFT           6
#define  DANZEFF_ALT             7
#define  DANZEFF_CONTROL         8
#define  DANZEFF_RETURN          9
#define  DANZEFF_CAPSLOCK        10
#define  DANZEFF_SUPPR           11
